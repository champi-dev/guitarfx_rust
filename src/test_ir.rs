// Test for IR loading functionality
#[cfg(test)]
mod tests {
    use crate::dsp::{CabinetType, PublicCabinetSimulator as CabinetSimulator};

    #[test]
    fn test_real_ir_loading() {
        ...
        println!("🔄 Testing cabinet switching...");
        ...
        // Test mix control
        println!("🎛️  Testing cabinet mix control...");
        ...
        println!("🎸 IR Loading Test Complete!");
    }
}